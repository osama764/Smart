...
let Najaf = document.getElementById("Najaf");
...
condition.addEventListener("change", (e) => {
  if (e.target.checked) {
    ...
    for (let i = 1; i <= 25; i++) {
      let device = `<option>سبوت${i}</option>`;
...
magneticLight.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>بروفايل${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
spot.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>ماجناتيك${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
profileLight.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>غاز${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
Chandelier.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>ليد${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
TV.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>تلفزيون${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
Najaf.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>نجفه${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
conditioning.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>تكييف${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
fan.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>مروحه${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
...
Half.addEventListener("change", (e) => {
  if (e.target.checked) {
    NameOfDevice.innerHTML = "";
    for (let i = 1; i <= 25; i++) {
      let device = `<option>شطر${i}</option>`;
      NameOfDevice.innerHTML += device;
    }
  } else {
    NameOfDevice.innerHTML = "";
